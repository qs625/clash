...
- The repo contains an AUR template at `packaging/aur/clash-nyanpasu-qs-bin/`.
...
5. Keep a distinct AUR package name if the upstream AUR package name is already taken.
6. For AUR publication, follow the command sequence in [aur-publish.md](./references/aur-publish.md).
